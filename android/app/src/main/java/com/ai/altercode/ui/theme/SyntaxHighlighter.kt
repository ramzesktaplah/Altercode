...
object SyntaxHighlighter {
    ...
    // Performance optimization: Precompute keyword sets per language to avoid map/set heap allocations on every highlight pass
    ...
    // Performance optimization: Precompute line comment token lists per language
